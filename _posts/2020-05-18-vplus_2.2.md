...
<table style="width:65%; border:none; background:none">
    <tr style="border:none; background:none; height: 40px">
        ...
        <th style="width:40%; border:none; background:none">
            <a href="https://www.curseforge.com/minecraft/customization/vanilla-plus-shader/files/2960120">Vanilla Plus v2.2</a>
        </th>
    </tr>
    <tr style="border:none; background:none; height: 40px">
        <th style="width:40%; border:none; background:none">
        ...
        <th style="width:40%; border:none; background:none">
            <a href="https://github.com/rre36/vplus_web/releases/download/v2.2/VPlus_v2.2.zip">Vanilla Plus v2.2</a>
        </th>
    </tr>
</table>
